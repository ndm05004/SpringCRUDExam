...
public class BookDAO {
	 ...
	 * 1) 첫번째 파라미터 SQL는 Mapper의 id이다.
	 * 		book_SQL.xml에서 namespace로 설정한 'Book'과 insert 쿼리를 실행하기 위해 만든 insert문의 id의 값 insert이다
	 ...
	 * 그리고, useGeneratedKey와 keyProperty의 설정으로 book 테이블의 pk인 book_id 항목을 생성할 수 있다.(mapper xml 참고)
	 * 
	 */
	...
	public Map<String, Object> selectBook(Map<String, Object> map) {
		 ...
		 * 쿼리 겨로가가 여러 개면 TooManyResultException 예외를 던진다.
		 * 우리가 작성한 쿼리는 조건이 pk이고, pk는 무조건 행이 유일함을 보장하기 때문에 결과는 0이 아니면 1개이다.
		 */
	...
	public List<Map<String, Object>> selectBookList(Map<String, Object> map) {
		 ...
		 * 리턴타입을 List타입으로 설정한 건, selectList 메소드의 결과가 집합 목록으로 반환하기 때문이다.
		 */
